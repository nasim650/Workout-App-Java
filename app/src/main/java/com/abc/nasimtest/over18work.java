...
public class over18work extends AppCompatActivity {

    int[] UArray;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_over18work);
        UArray = new int[]{
    ...
    public void Under18ImageClick(View view) {
        for(int i=0; i<UArray.length;i++){
            if(view.getId()==UArray[i]){
                ...
                Intent intent= new Intent(over18work.this, ex1_prossingSystem2.class);
